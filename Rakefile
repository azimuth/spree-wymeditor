...
desc 'Generate documentation for the wymeditor extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'WymeditorExtension'
...
desc 'Test the wymeditor extension.'
...
namespace :test do
  desc 'Functional test the wymeditor extension.'
  ...
  desc 'Unit test the wymeditor extension.'
